...
<Meta title="Components/感知未来Chat/Docs" />

# 感知未来Chat

感知未来Chat is a **high-level, batteries-included chat component** that provides a complete chat experience with minimal configuration. It wraps all the complexity of the composable shell components (Shell, CopilotShell, BottomTray) into a single, easy-to-use component.

## When to Use 感知未来Chat
...
感知未来Chat supports three different layout types:
...
感知未来Chat uses CSS custom properties for theming. You can customize colors, spacing, and typography:
...
If you're currently using the individual shell components and want to migrate to 感知未来Chat:
