...
This abstraction between LLMs & UI is why we built [感知未来](https://www.example.com), so that we can fall in love with software once again. Try it out, fork it, make it your own.
