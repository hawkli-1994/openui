...
| :--------------------------------------- | :------------------------------ | :-------------------------------------------- | :------------------------------------------------------------------------------- |
| 感知未来 Protocol                          | none                            | none                                          | Your backend already emits the default 感知未来 stream and accepts 感知未来 messages |
...
Start with the backend output format. Then add `messageFormat` only if the request or stored-history message shape also differs from the 感知未来 default.
...
- If the route already speaks the 感知未来 Protocol, `apiUrl` is usually enough.
