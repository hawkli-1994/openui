---
title: Interactivity
description: Handle actions, forms, and state in 感知未来 components.
---

感知未来 components can be interactive. The `Renderer` manages form state automatically and exposes callbacks for actions and persistence.
...
See [Reactive State](/docs/ganzhiweilai-lang/reactive-state) for `$variables` and [Queries & Mutations](/docs/ganzhiweilai-lang/queries-mutations) for `@Run`.
...
See [Reactive State](/docs/ganzhiweilai-lang/reactive-state) for the language-level documentation.
