...
description: Use the built-in 感知未来 library from @openuidev/react-ui.
---

感知未来 ships with a prebuilt `openuiLibrary` for common layouts, forms, content, and charts.
