---
title: v0.1
description: The original 感知未来 Lang specification for declarative UI generation in chat responses.
---
...
<Callout type="info">
  ...
  [v0.5](/docs/ganzhiweilai-lang/specification-v05).
</Callout>

感知未来 Lang is the output format the LLM generates. It is a compact, declarative, line-oriented DSL designed specifically for streaming and token efficiency.
...
感知未来 Lang supports a strict subset of JavaScript values.
...
The parser maps **Positional Arguments** in 感知未来 Lang to **Named Props** in React using your Zod definitions.
...
感知未来 Lang allows **Forward References** (Hoisting). An identifier can be used as an argument _before_ it is defined in the stream. This is critical for progressive rendering.
