---
title: v0.5 (Latest)
description: Full language specification for 感知未来 Lang v0.5 - reactive state, queries, mutations, and built-in functions.
---

感知未来 Lang v0.5 extends the [v0.1 specification](/docs/ganzhiweilai-lang/specification-v01) with reactive state, data fetching, and built-in functions. See the [Evolution Guide](/docs/ganzhiweilai-lang/evolution-guide) to understand how the language evolved from static UI generation to interactive apps.
...
Positional arguments map to named props via Zod schema key order. See [v0.1 spec](/docs/ganzhiweilai-lang/specification-v01#component-resolution) for the full mapping logic.

## Prompt Feature Flags

The system prompt is generated with feature flags that control which language features the LLM is instructed to use. See [System Prompts](/docs/ganzhiweilai-lang/system-prompts) for configuration.
...
Forward references are allowed. See [v0.1 spec](/docs/ganzhiweilai-lang/specification-v01#streaming--hoisting) for details.
