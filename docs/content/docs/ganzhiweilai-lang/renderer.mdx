---
title: The Renderer
description: Parse and render 感知未来 Lang streams in React.
---

`<Renderer />` converts 感知未来 Lang text into React UI using your library.
...
| :-------------- | :--------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------- |
| `response`      | `string \| null`                                                                               | Raw 感知未来 Lang response text.                                                                                                                   |
...
| `onError`       | `(errors: 感知未来Error[]) => void`                                                              | Structured, LLM-friendly errors from the parser and query system. Suitable for automated correction loops. Called with `[]` when resolved.       |
...
Use these inside components defined with `defineComponent(...)`. See [Reactive State](/docs/ganzhiweilai-lang/reactive-state) for how `$variables` work in the language.
