...
description: Generate and customize prompt instructions from your 感知未来 library.
---

The system prompt tells the LLM how to output valid 感知未来 Lang. There are two ways to generate it.
