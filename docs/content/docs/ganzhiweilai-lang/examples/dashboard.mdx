---
title: Dashboard App
description: A data-driven dashboard with tools, MCP, and interactive charts built with 感知未来.
---
...
[View source on GitHub →](https://github.com/example/example/tree/main/examples/openui-dashboard)
